var palermo_repeating_sortable_init = function( selector ) {
...
var palermo_repeating_colorpicker_init = function( ) {
...
jQuery(document).ready(function($) {
	...
	// Repeating fields
	palermo_repeating_sortable_init();
	...
	$body.on( 'click', '.ci-repeating-add-field', function( e ) {
		...
		palermo_repeating_sortable_init();
		palermo_repeating_colorpicker_init();
		e.preventDefault();
	} );
