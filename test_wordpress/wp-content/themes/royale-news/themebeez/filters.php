	...
	function royale_news_comment_form_fileds( $fields ) {
		...
		$fields   =  array(
			'author'=>  '<div class="form-group">
							<label for="author">'.esc_html__("Full Name *", "royale-news").'</label>
			...
			'email'=>   '<div class="form-group">
							<label for="email">'.esc_html__("Email Address *", "royale-news").'</label>
			...
			'url'=>     '<div class="form-group">
							<label for="url">'.esc_html__('Website', 'royale-news').'</label>
...
if( !function_exists( 'royale_news_comment_form' ) ) :
	...
	function royale_news_comment_form( $args ) {
		...
		$args['comment_field'] = '<div class="form-group">
									<label for="comment">'.esc_html__('Comment','royale-news').'</label>
